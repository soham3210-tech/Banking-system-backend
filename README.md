...
The complete API documentation and interactive testing interface are available through Swagger UI:

🔗 https://banking-system-backend-ndzf.onrender.com/api-docs

You can use Swagger to explore endpoints, test requests, and view API responses.
